...
build_router_prompt() { # <current-id> <message-file> [history-file]
	...
	printf 'When the captain addresses Firstmate directly, the message is for THIS\n'
	printf 'session: answer "same" immediately and do not reason about routing it away.\n'
	printf 'Direct address is the signal, usually at the start of the message and in any\n'
	printf 'letter case: "Firstmate:", "Firstmate,", "@firstmate", or the same name used\n'
	printf 'to call on Firstmate. Merely mentioning firstmate the project, or discussing\n'
	printf 'firstmate work in the third person, is NOT addressing Firstmate and stays\n'
	printf 'subject to the normal rules above.\n\n'
