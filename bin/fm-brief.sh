...
# briefs stay byte-identical, and so an apostrophe in a heredoc body no longer
# trips the Bash 3.2 command-substitution parser (unmatched-quote scan past EOF).
DOD=${DOD%$'\n'}
